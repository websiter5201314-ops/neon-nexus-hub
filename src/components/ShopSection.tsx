...
const products: Product[] = [
  {
    ...
    price: '$4.99',
    rarity: 'common',
    description: 'Basic gaming tips & tricks guide',
  ...
  },
  {
    ...
    price: '$9.99',
    rarity: 'rare',
    description: 'Advanced gameplay techniques',
  ...
  },
  {
    ...
    price: '$19.99',
    rarity: 'epic',
    description: '1-on-1 coaching session included',
  ...
  },
  {
    ...
    price: '$49.99',
    rarity: 'legendary',
    description: 'Full mentorship + exclusive content',
